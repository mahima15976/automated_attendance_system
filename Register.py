    ...
    def registering(self):
        ...
        try:
            ...
            if name == "" or name == "null" or unm == "" or unm == "null" or pwd == "" or pwd == "null" or email == "" or email == "null" or mno == "" or mno == "null":
                ...
                sql = "select count(*) from faculty where factid='" + unm + "'"
                cursor.execute(sql)
...
"font: 75 14pt \"Times New Roman\";")
        ...
        self.label_7.setStyleSheet("image: url(../AttendanceSystem/images/registration.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Faculty ID"))
